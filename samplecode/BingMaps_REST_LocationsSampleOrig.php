...
<body>
 ...
 //Creamos un contexto para realizar la llamada al servicio con las opciones HTTP que leen el proxy

    $context = createStreamContext();
    //permite leer el contenido de un archivo o una URL (como si fuera una página web o un servicio API).
     $output = file_get_contents($findURL,  false, $context);
